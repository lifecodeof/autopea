...
COPY packages/autopea/tsdown.config.ts packages/autopea/tsconfig.json packages/autopea/tsdown-env.d.ts packages/autopea/
...
# ---------------------------------------------------------------------------
# test: Chromium + vitest runner for the tests package
# ---------------------------------------------------------------------------
FROM base AS test
